...
public class CategoryParser extends Parser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "SLASH", "BASESTRING", "UPPER", "LOWER", "'['", "']'", "'('", "')'"
    };
    ...
    public String getGrammarFileName() { return "Category.g"; }
    ...
    // $ANTLR start atom
    // Category.g:92:1: atom returns [Cat value] : (atomcat= BASESTRING ( '[' feature= BASESTRING ']' )? | '(' cat ')' );
    public final Cat atom() throws RecognitionException {
        ...
        try {
            // Category.g:93:5: (atomcat= BASESTRING ( '[' feature= BASESTRING ']' )? | '(' cat ')' )
            int alt3=2;
            ...
            if ( (LA3_0==BASESTRING) ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("92:1: atom returns [Cat value] : (atomcat= BASESTRING ( '[' feature= BASESTRING ']' )? | '(' cat ')' );", 3, 0, input);
